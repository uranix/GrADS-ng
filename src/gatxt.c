...
char *gatxtl(char *str, gaint level) { /* colorize according to level */
  ...
  if (scheme == 0) {
    if (level == -1)
      return gatxts(str, "Green"); /* prompt */
    if (level == 0)
      return gatxts(str, "Red");
    if (level == 1)
      return gatxts(str, "magenta");
    if (level == 2)
      return gatxts(str, "yellow");
  } else if (scheme == 1) {
    if (level == -1)
      return gatxts(str, "Green"); /* prompt */
    if (level == 0)
    ...
    if (level == 1)
      return gatxts(str, "magenta");
    if (level == 2)
      return gatxts(str, "blue");
  } else if (scheme == 2) {
    if (level == -1)
      return gatxts(str, "Blue"); /* prompt */
    if (level == 0)
      return gatxts(str, "black");
    if (level == 1)
      return gatxts(str, "magenta");
    if (level == 2)
      return gatxts(str, "white");
  }
  return (str);
}
