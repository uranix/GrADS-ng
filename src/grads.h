...
char *stnvar(char *, char *, struct gafile *, struct gavar *, struct gastat *);
...
void trfill(float, float, float, float, float, float, float, float, float, gaint, gaint);
...
gadouble wndexit(gadouble, gadouble, gadouble, gadouble, gadouble, gadouble *, gadouble *, gadouble *, gadouble *);
...
void gaimap(gadouble *, gaint, gaint, gadouble *, gaint *, gaint, char *, gadouble, gadouble, gadouble, gadouble);
