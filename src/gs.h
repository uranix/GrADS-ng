...
struct gsrecd *gsbkst(struct gsrecd *, struct gsrecd *, struct gsrecd *, gaint *);
struct gsrecd *gsbkdo(struct gsrecd *, struct gsrecd *, struct gsrecd *, gaint *);
struct gsrecd *gsbkif(struct gsrecd *, struct gsrecd *, struct gsrecd *, gaint *);
