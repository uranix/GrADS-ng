...
gaint gxdbqhersh(void) { return (hershflag); }
...
gaint gxdbqtransclr(void) { return (dbtransclr); }

/* Set transparent color (for image output) */

void gxdbsettransclr(gaint clr) { dbtransclr = clr; }

/* Set device background color. */

void gxdbck(gaint clr) { dbdevbck = clr; }

/* Set output background color */

void gxdboutbck(gaint clr) { dboutbck = clr; }
