...
void gxpcfg(void) { gxGDcfg(); }

/* Check to see if this printing backend supports fonts */
gaint gxpckfont(void) { return (0); }
...
void gxpcol(gaint col) { /* new color */ gxGDcol(col); }
void gxpacol(gaint col) { /* new color definition */ gxGDacol(col); }
void gxpwid(gaint wid) { /* new line thickness */ gxGDwid(wid); }
void gxprec(gadouble x1, gadouble x2, gadouble y1, gadouble y2) { /* filled rectangle */ gxGDrec(x1, x2, y1, y2); }
void gxpbpoly(void) { /* start a polygon fill */ gxGDbpoly(); }
gaint gxpepoly(gadouble *xybuf, gaint xyc) { /* terminate a polygon fill */
  rc = gxGDepoly(xybuf, xyc);
  return (rc);
}
void gxpmov(gadouble xpos, gadouble ypos) { /* move to */ gxGDmov(xpos, ypos); }
void gxpdrw(gadouble xpos, gadouble ypos) { /* draw to */ gxGDdrw(xpos, ypos); }
void gxpflush(void) { /* finish drawing */ gxGDflush(); }
...
void gxpend(void) {}
gadouble gxpch(char ch, gaint fn, gadouble x, gadouble y, gadouble w, gadouble h, gadouble rot) { return 0; }
gadouble gxpqchl(char ch, gaint fn, gadouble w) { return -999; }
