...
void s2flags(gadouble *r, char *u, gaint is, gaint js, gadouble c1, gadouble c2) {
  ...
  for (jg = 0; jg < js; jg++) {
    ...
    for (ig = 0; ig < is; ig++) {
      *(pflg + ijg) = 0;
      if (*(u + ijg)) {
        if (*(r + ijg) > c1 && *(r + ijg) <= c2)
          *(pflg + ijg) = 1; /* pflg true if within shade range */
      }
      ijg++;
    }
  }
    ...
    for (ig = 0; ig < is - 1; ig++) {
      ...
      *(s4flg + ijg) = 0;
      ...
      if (*(pflg + ijg) && *(pflg + ijg + is)) {
        if (ig == 0)
          *(s1flg + ijg) = 10;
        else if (*(u + ijg - 1) == 0 || *(u + ijg + is - 1) == 0)
          *(s1flg + ijg) = 10;
      }
      if (*(pflg + ijg + is) && *(pflg + ijg + is + 1)) {
        if (jg == js - 2)
          *(s2flg + ijg) = 10;
        else if (*(u + ijg + is * 2) == 0 || *(u + ijg + is * 2 + 1) == 0)
          *(s2flg + ijg) = 10;
      }
      if (*(pflg + ijg + is + 1) && *(pflg + ijg + 1)) {
        if (ig == is - 2)
          *(s3flg + ijg) = 10;
        else if (*(u + ijg + 2) == 0 || *(u + ijg + is + 2) == 0)
          *(s3flg + ijg) = 10;
      }
      if (*(pflg + ijg + 1) && *(pflg + ijg)) {
        if (jg == 0)
          *(s4flg + ijg) = 10;
        else if (*(u + ijg - is) == 0 || *(u + ijg + 1 - is) == 0)
          *(s4flg + ijg) = 10;
      }
  ...
  for (jg = 0; jg < js - 1; jg++) {
    ...
    for (ig = 0; ig < is - 1; ig++) {
      if (*(s1flg + ijg) > 0 && *(s1flg + ijg) < 7) {
        if (ig == 0)
          *(s1flg + ijg) += 10;
        else if (*(s3flg + ijg - 1) == 0)
          *(s1flg + ijg) += 10;
      }
      if (*(s2flg + ijg) > 0 && *(s2flg + ijg) < 7) {
        if (jg == js - 2)
          *(s2flg + ijg) += 10;
        else if (*(s4flg + ijg + is) == 0)
          *(s2flg + ijg) += 10;
      }
      if (*(s3flg + ijg) > 0 && *(s3flg + ijg) < 7) {
        if (ig == is - 2)
          *(s3flg + ijg) += 10;
        else if (*(s1flg + ijg + 1) == 0)
          *(s3flg + ijg) += 10;
      }
      if (*(s4flg + ijg) > 0 && *(s4flg + ijg) < 7) {
        if (jg == 0)
          *(s4flg + ijg) += 10;
        else if (*(s2flg + ijg - is) == 0)
          *(s4flg + ijg) += 10;
      }
      ijg++;
    }
  ...
  for (jg = 0; jg < js - 1; jg++) {
    ...
    for (ig = 1; ig < is - 1; ig++) {
      if (!*(pflg + ijg) && *(s1flg + ijg) > 0 && *(s1flg + ijg) < 7) {
        if (*(s4flg + ijg - 1) > 0 && *(s4flg + ijg - 1) < 7)
          flag = 1;
  ...
  for (jg = 1; jg < js - 1; jg++) {
    ijg = jg * is + 1;
    for (ig = 1; ig < is - 1; ig++) {
      if ((*(pflg + ijg) && *(s4flg + ijg - 1) > 9 && *(s4flg + ijg) < 10 && *(s3flg + ijg - 1) < 10 && *(s1flg + ijg) < 10) ||
          (!*(pflg + ijg) && *(s4flg + ijg - 1) > 9 && *(s4flg + ijg) < 10 && *(s1flg + ijg) < 10 && *(s1flg + ijg) > 0)) {
        jj = jg;
        while (jj < js - 1) {
          if (*(u + (jj + 1) * is + ig) == 0)
            break;
...
void s2poly(gadouble *r, gaint is, gaint js, gadouble c1, gadouble c2) {
  ...
  for (jg = 0; jg < js - 1; jg++) {
    ...
    for (ig = 0; ig < is - 1; ig++) {
      rc = 0;
      if (*(s1flg + ijg))
        rc = s2follow(r, is, js, c1, c2, 1, ig, jg);
      if (*(s2flg + ijg))
        rc = s2follow(r, is, js, c1, c2, 2, ig, jg);
      if (*(s3flg + ijg))
        rc = s2follow(r, is, js, c1, c2, 3, ig, jg);
      if (*(s4flg + ijg))
        rc = s2follow(r, is, js, c1, c2, 4, ig, jg);
      if (rc)
        return;
      ijg++;
    }
...
gaint s2follow(gadouble *r, gaint is, gaint js, gadouble c1, gadouble c2, gaint side, gaint ig, gaint jg) {
...
side1i1: /* Enter on side 1; c1 intersect */
  ...
  if (sflg) {
    if (f1 == 2) {
      ...
      *(s1flg + ij) = 14;
    if (ii == ig && jj == jg && side == 1)
      goto done;
  }
  sflg = 1;
  if ((f4 == 2 || f4 == 6 || f4 == 12 || f4 == 16) && (f2 == 1 || f2 == 5 || f2 == 11 || f2 == 15)) { /* col */
    if (s2col(c1, ii, jj)) {
      if (f2 == 1 || f2 == 5) {
        jj++;
        goto side4i1;
...
side2i1: /* Enter on side 2; c1 intersect */
  ...
  if (sflg) {
    if (f2 == 2) {
      ...
      *(s2flg + ij) = 14;
    if (ii == ig && jj == jg && side == 2)
      goto done;
  }
  sflg = 1;
  if ((f1 == 1 || f1 == 5 || f1 == 11 || f1 == 15) && (f3 == 2 || f3 == 6 || f3 == 12 || f3 == 16)) { /* col */
    if (s2col(c1, ii, jj)) {
      if (f1 == 1 || f1 == 5) {
        ii--;
        goto side3i1;
...
side3i1: /* Enter on side 3; c1 intersect */
  ...
  if (sflg) {
    if (f3 == 1) {
      ...
      *(s3flg + ij) = 13;
    if (ii == ig && jj == jg && side == 3)
      goto done;
  }
  sflg = 1;
  if ((f2 == 1 || f2 == 5 || f2 == 11 || f2 == 15) && (f4 == 2 || f4 == 6 || f4 == 12 || f4 == 16)) { /* col */
    if (s2col(c1, ii, jj)) {
      if (f4 == 2 || f4 == 6) {
        jj--;
        goto side2i1;
...
side4i1: /* Enter on side 4; c1 intersect */
  ...
  if (sflg) {
    if (f4 == 1) {
      ...
      *(s4flg + ij) = 13;
    if (ii == ig && jj == jg && side == 4)
      goto done;
  }
  sflg = 1;
  if ((f3 == 2 || f3 == 6 || f3 == 12 || f3 == 16) && (f1 == 1 || f1 == 5 || f1 == 11 || f1 == 15)) { /* col */
    if (s2col(c1, ii, jj)) {
      if (f3 == 2 || f3 == 6) {
        ii++;
        goto side1i1;
...
side1i2: /* Enter on side 1; c2 intersect */
  ...
  sflg = 1;
  if ((f4 == 3 || f4 == 5 || f4 == 13 || f4 == 15) && (f2 == 4 || f2 == 6 || f2 == 14 || f2 == 16)) { /* col */
    if (s2col(c2, ii, jj)) {
      if (f2 == 4 || f2 == 6) {
        jj++;
        goto side4i2;
...
side2i2: /* Enter on side 2; c2 intersect */
  ...
  sflg = 1;
  if ((f1 == 4 || f1 == 6 || f1 == 14 || f1 == 16) && (f3 == 3 || f3 == 5 || f3 == 13 || f3 == 15)) { /* col */
    if (s2col(c2, ii, jj)) {
      if (f1 == 4 || f1 == 6) {
        ii--;
        goto side3i2;
...
side3i2: /* Enter on side 3; c2 intersect */
  ...
  sflg = 1;
  if ((f2 == 4 || f2 == 6 || f2 == 14 || f2 == 16) && (f4 == 3 || f4 == 5 || f4 == 13 || f4 == 15)) { /* col */
    if (s2col(c2, ii, jj)) {
      if (f4 == 3 || f4 == 5) {
        jj--;
        goto side2i2;
...
side4i2: /* Enter on side 4; c2 intersect */
  ...
  sflg = 1;
  if ((f3 == 3 || f3 == 5 || f3 == 13 || f3 == 15) && (f1 == 4 || f1 == 6 || f1 == 14 || f1 == 16)) { /* col */
    if (s2col(c2, ii, jj)) {
      if (f3 == 3 || f3 == 5) {
        ii++;
        goto side1i2;
...
void s2box(gadouble v1, gadouble v2, gadouble v3, gadouble v4, gadouble c1, gadouble c2) {
  ...
  if ((v1 <= c1 && v2 > c1) || (v1 > c1 && v2 <= c1))
    fl1a = 1;
  if ((v1 <= c2 && v2 > c2) || (v1 > c2 && v2 <= c2))
    fl1b = 1;

  if ((v2 <= c1 && v3 > c1) || (v2 > c1 && v3 <= c1))
    fl2a = 1;
  if ((v2 <= c2 && v3 > c2) || (v2 > c2 && v3 <= c2))
    fl2b = 1;

  if ((v3 <= c1 && v4 > c1) || (v3 > c1 && v4 <= c1))
    fl3a = 1;
  if ((v3 <= c2 && v4 > c2) || (v3 > c2 && v4 <= c2))
    fl3b = 1;

  if ((v4 <= c1 && v1 > c1) || (v4 > c1 && v1 <= c1))
    fl4a = 1;
  if ((v4 <= c2 && v1 > c2) || (v4 > c2 && v1 <= c2))
    fl4b = 1;
  ...
  if (np == 0)
    return; /* If no intersects, just return */
  ...
  col1 = 0;
  col2 = 0;
  if (fl1a && fl2a && fl3a && fl4a)
    col1 = 1;
  if (fl1b && fl2b && fl3b && fl4b)
    col2 = 1;
...
void s2ppnt(gadouble x, gadouble y) {
  ...
  if (pnum > xynum - 3) {
    xynum = xynum * 2;
    if (bug)
      printf("Poly buff memory for %i points\n", xynum);
...
void s2setbuf(gaint flg) { bufopt = flg; }

/* Turn drawing of polygons on/off. If 1, polygons are not drawn */

void s2setdraw(gaint flg) { nodraw = flg; }
